 ...
 * of this value object you may modify the generated sub-class of this class - CmisPropertyIntegerDefinitionType.as.
 */
...
[ExcludeClass]
public class _Super_CmisPropertyIntegerDefinitionType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisPropertyIntegerDefinitionTypeEntityMetadata;
    ...
    private var _internal_defaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyInteger;
    private var _internal_maxValue : int;
    private var _internal_minValue : int;
    private var _internal_choice : ArrayCollection;
    model_internal var _internal_choice_leaf:org.integratedsemantics.cmis.soap.valueobject.CmisChoiceInteger;
    ...
    public function _Super_CmisPropertyIntegerDefinitionType()
    {
        _model = new _CmisPropertyIntegerDefinitionTypeEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get defaultValue() : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyInteger
    {
    ...
    public function set defaultValue(value:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyInteger) : void
    {
        var oldValue:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyInteger = _internal_defaultValue;
        if (oldValue !== value)
        {
    ...
    {
        var oldValue:int = _internal_maxValue;
        if (oldValue !== value)
        {
    ...
    {
        var oldValue:int = _internal_minValue;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisPropertyIntegerDefinitionTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisPropertyIntegerDefinitionTypeEntityMetadata) : void
    {
        var oldValue : _CmisPropertyIntegerDefinitionTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfDefaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyInteger;

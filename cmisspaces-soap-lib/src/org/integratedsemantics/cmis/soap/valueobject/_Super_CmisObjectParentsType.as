 ...
 * of this value object you may modify the generated sub-class of this class - CmisObjectParentsType.as.
 */
...
[ExcludeClass]
public class _Super_CmisObjectParentsType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisObjectParentsTypeEntityMetadata;

    /**
     * properties
     */
    private var _internal_object : org.integratedsemantics.cmis.soap.valueobject.CmisObjectType;
    private var _internal_relativePathSegment : String;
    ...
    public function _Super_CmisObjectParentsType()
    {
        _model = new _CmisObjectParentsTypeEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "relativePathSegment", model_internal::setterListenerRelativePathSegment));
    ...
    [Bindable(event="propertyChange")]
    public function get relativePathSegment() : String
    {
        return _internal_relativePathSegment;
    }
    ...
    public function set relativePathSegment(value:String) : void
    {
        var oldValue:String = _internal_relativePathSegment;
        if (oldValue !== value)
        {
            _internal_relativePathSegment = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "relativePathSegment", oldValue, _internal_relativePathSegment));
        }
    }
    ...
    model_internal function setterListenerRelativePathSegment(value:flash.events.Event):void
    {
        _model.invalidateDependentOnRelativePathSegment();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.relativePathSegmentIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_relativePathSegmentValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisObjectParentsTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisObjectParentsTypeEntityMetadata) : void
    {
        var oldValue : _CmisObjectParentsTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfRelativePathSegment : Array = null;
    model_internal var _doValidationLastValOfRelativePathSegment : String;

    model_internal function _doValidationForRelativePathSegment(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfRelativePathSegment != null && model_internal::_doValidationLastValOfRelativePathSegment == value)
           return model_internal::_doValidationCacheOfRelativePathSegment ;

        _model.model_internal::_relativePathSegmentIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isRelativePathSegmentAvailable && _internal_relativePathSegment == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "relativePathSegment is required"));
        }

        model_internal::_doValidationCacheOfRelativePathSegment = validationFailures;
        model_internal::_doValidationLastValOfRelativePathSegment = value;

package org.integratedsemantics.cmisspacesairmobile.view.main
{   
    ...
    import org.integratedsemantics.cmisspacesmobile.view.main.CMISSpacesMobileViewBase;
    ...
    import org.integratedsemantics.cmisspacesairmobile.view.filebrowse.MobileDownload;


    public class CMISSpacesAirMobileViewBase extends CMISSpacesMobileViewBase
    {
        // local files browser
        protected var localFilesView:LocalFilesBrowserView;
        
        // create html content dialog (keep after first use)
        ...
        public function CMISSpacesAirMobileViewBase()
        {
            super();
        }
    	...
    	public function set cmisSpacesAirPresModel(cmisSpacesAirPresModel:CMISSpacesPresModel):void
        {
        ...
        {
            return this.flexSpacesPresModel;
        }
        ...
        {      
			...
			//todo: this is not needed since still have top level creationpolicy all

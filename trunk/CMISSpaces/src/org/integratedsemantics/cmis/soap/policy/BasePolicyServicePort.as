...
BasePolicyServicePortService = new WSDLService("BasePolicyServicePortService");
            ...
            BasePolicyServicePortService.getPort("BasePolicyServicePortPort").binding.portType.addOperation(getAppliedPolicies);
							...
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://docs.oasis-open.org/ns/cmis/core/200908/","enumDateTimeResolution"),org.integratedsemantics.cmis.soap.policy.EnumDateTimeResolution);
							...
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://docs.oasis-open.org/ns/cmis/core/200908/","enumSupportedPermissions"),org.integratedsemantics.cmis.soap.policy.EnumSupportedPermissions);

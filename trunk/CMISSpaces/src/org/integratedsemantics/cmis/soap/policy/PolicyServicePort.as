 ...
 */
  ...
  * myService.removePolicy(myrepositoryId,mypolicyId,myobjectId,myextension);
  *
  * MXML sample code:
  * First you need to map the package where the files were generated to a namespace, usually on the <mx:Application> tag, 
  * like this: xmlns:srv="org.integratedsemantics.cmis.soap.policy.*"
  * Define the service and within its tags set the request wrapper for the desired operation
  * <srv:PolicyServicePort id="myService">
  *   <srv:removePolicy_request_var>
  *		<srv:RemovePolicy_request repositoryId=myValue,policyId=myValue,objectId=myValue,extension=myValue/>
  *   </srv:removePolicy_request_var>
...
package org.integratedsemantics.cmis.soap.policy
{
     ...
     */
    [Event(name="RemovePolicy_result", type="org.integratedsemantics.cmis.soap.policy.RemovePolicyResultEvent")]
     ...
     */
    [Event(name="ApplyPolicy_result", type="org.integratedsemantics.cmis.soap.policy.ApplyPolicyResultEvent")]
     ...
     */
    [Event(name="GetAppliedPolicies_result", type="org.integratedsemantics.cmis.soap.policy.GetAppliedPoliciesResultEvent")]
	...
	public class PolicyServicePort extends EventDispatcher implements IPolicyServicePort
	{
        ...
        {
         	var _internal_token:AsyncToken = _baseService.removePolicy(repositoryId,policyId,objectId,extension);
        ...
        {
        	return removePolicy(_removePolicy_request.repositoryId,_removePolicy_request.policyId,_removePolicy_request.objectId,_removePolicy_request.extension);
        }
		 ...
		 * @private
		 */
        private var _removePolicy_lastResult:CmisExtensionType;
		[Bindable]
		/**
		 * @see IPolicyServicePort#removePolicy_lastResult
		 */	  
		public function get removePolicy_lastResult():CmisExtensionType
		{
		 ...
		 * @private
		 */
		public function set removePolicy_lastResult(lastResult:CmisExtensionType):void
		{
        ...
        {
         	var _internal_token:AsyncToken = _baseService.applyPolicy(repositoryId,policyId,objectId,extension);
        ...
        {
        	return applyPolicy(_applyPolicy_request.repositoryId,_applyPolicy_request.policyId,_applyPolicy_request.objectId,_applyPolicy_request.extension);
        }
		 ...
		 * @private
		 */
        private var _applyPolicy_lastResult:CmisExtensionType;
		[Bindable]
		/**
		 * @see IPolicyServicePort#applyPolicy_lastResult
		 */	  
		public function get applyPolicy_lastResult():CmisExtensionType
		{
		 ...
		 * @private
		 */
		public function set applyPolicy_lastResult(lastResult:CmisExtensionType):void
		{
        ...
        {
         	var _internal_token:AsyncToken = _baseService.getAppliedPolicies(repositoryId,objectId,filter,extension);
        ...
        {
        	return getAppliedPolicies(_getAppliedPolicies_request.repositoryId,_getAppliedPolicies_request.objectId,_getAppliedPolicies_request.filter,_getAppliedPolicies_request.extension);
        }

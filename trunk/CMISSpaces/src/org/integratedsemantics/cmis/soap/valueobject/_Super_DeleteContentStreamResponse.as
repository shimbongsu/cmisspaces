 ...
 * of this value object you may modify the generated sub-class of this class - DeleteContentStreamResponse.as.
 */
...
[ExcludeClass]
public class _Super_DeleteContentStreamResponse extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _DeleteContentStreamResponseEntityMetadata;

    /**
     * properties
     */
    private var _internal_objectId : String;
    private var _internal_changeToken : String;
    ...
    public function _Super_DeleteContentStreamResponse()
    {
        _model = new _DeleteContentStreamResponseEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "changeToken", model_internal::setterListenerChangeToken));
    ...
    [Bindable(event="propertyChange")]
    public function get changeToken() : String
    {
        return _internal_changeToken;
    }
    ...
    public function set changeToken(value:String) : void
    {
        var oldValue:String = _internal_changeToken;
        if (oldValue !== value)
        {
            _internal_changeToken = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "changeToken", oldValue, _internal_changeToken));
        }
    }
    ...
    model_internal function setterListenerChangeToken(value:flash.events.Event):void
    {
        _model.invalidateDependentOnChangeToken();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.changeTokenIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_changeTokenValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _DeleteContentStreamResponseEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _DeleteContentStreamResponseEntityMetadata) : void
    {
        var oldValue : _DeleteContentStreamResponseEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfChangeToken : Array = null;
    model_internal var _doValidationLastValOfChangeToken : String;

    model_internal function _doValidationForChangeToken(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfChangeToken != null && model_internal::_doValidationLastValOfChangeToken == value)
           return model_internal::_doValidationCacheOfChangeToken ;

        _model.model_internal::_changeTokenIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isChangeTokenAvailable && _internal_changeToken == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "changeToken is required"));
        }

        model_internal::_doValidationCacheOfChangeToken = validationFailures;
        model_internal::_doValidationLastValOfChangeToken = value;

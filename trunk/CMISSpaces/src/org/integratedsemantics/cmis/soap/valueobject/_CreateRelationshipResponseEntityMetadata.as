...
[ExcludeClass]
internal class _CreateRelationshipResponseEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var entityName:String = "CreateRelationshipResponse";
    ...
    model_internal var _instance:_Super_CreateRelationshipResponse;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CreateRelationshipResponseEntityMetadata(value : _Super_CreateRelationshipResponse)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CreateRelationshipResponse");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CreateRelationshipResponse");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CreateRelationshipResponse");
        }

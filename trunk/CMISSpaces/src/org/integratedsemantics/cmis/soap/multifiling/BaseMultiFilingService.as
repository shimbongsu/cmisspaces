...
BaseMultiFilingServiceService = new WSDLService("BaseMultiFilingServiceService");
            ...
            BaseMultiFilingServiceService.getPort("BaseMultiFilingServicePort").binding.portType.addOperation(addObjectToFolder);
							...
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://docs.oasis-open.org/ns/cmis/core/200908/","enumDateTimeResolution"),org.integratedsemantics.cmis.soap.multifiling.EnumDateTimeResolution);
							...
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://docs.oasis-open.org/ns/cmis/core/200908/","enumSupportedPermissions"),org.integratedsemantics.cmis.soap.multifiling.EnumSupportedPermissions);

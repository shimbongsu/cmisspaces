...
package org.integratedsemantics.cmis.webservice.objectservice{
    ...
    public interface IObjectService
    {
       ...
       function addgetContentStreamEventListener(listener:Function):void;
    	 ...
    	 * @return An AsyncToken
    	 */
    	function getProperties(repositoryId:String,objectId:String,returnVersion:EnumReturnVersion,filter:String,includeAllowableActions:Boolean,includeRelationships:EnumIncludeRelationships):AsyncToken;
        /**
         * Method to call the operation on the server without passing the arguments inline.
         * You must however set the _request property for the operation before calling this method
         * Should use it in MXML context mostly

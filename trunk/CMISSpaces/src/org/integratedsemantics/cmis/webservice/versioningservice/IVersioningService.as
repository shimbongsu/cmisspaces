...
package org.integratedsemantics.cmis.webservice.versioningservice{
    ...
    public interface IVersioningService
    {
       ...
       function addgetPropertiesOfLatestVersionEventListener(listener:Function):void;
    	 ...
    	 * @return An AsyncToken
    	 */
    	function getAllVersions(repositoryId:String,versionSeriesId:String,filter:String,includeAllowableActions:Boolean,includeRelationships:Boolean):AsyncToken;
        /**
         * Method to call the operation on the server without passing the arguments inline.
         * You must however set the _request property for the operation before calling this method
         * Should use it in MXML context mostly

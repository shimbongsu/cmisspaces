 ...
 */
  ...
  * myService.addcheckOutEventListener(myResultHandlingFunction);
  * Step 3: Call the operation as a method on the service. Pass the right values as arguments:
  * myService.checkOut(myrepositoryId,mydocumentId);
  *
  * MXML sample code:
  ...
  *   <srv:checkOut_request_var>
  *		<srv:CheckOut_request repositoryId=myValue,documentId=myValue/>
  *   </srv:checkOut_request_var>
  * </srv:VersioningService>
  * Then call the operation for which you have set the request wrapper value above, like this:
  * <mx:Button id="myButton" label="Call operation" click="myService.checkOut_send()" />
  */

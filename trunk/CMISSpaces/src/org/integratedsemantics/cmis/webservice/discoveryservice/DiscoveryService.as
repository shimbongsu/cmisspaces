...
package org.integratedsemantics.cmis.webservice.discoveryservice
{
     ...
     */
    [Event(name="GetContentChanges_result", type="org.integratedsemantics.cmis.webservice.discoveryservice.GetContentChangesResultEvent")]
	...
	public class DiscoveryService extends EventDispatcher implements IDiscoveryService
	{
        ...
        {
         	var _internal_token:AsyncToken = _baseService.getContentChanges(repositoryId,changeToken,maxItems,includeACL,includeProperties,filter);
        ...
        {
        	return getContentChanges(_getContentChanges_request.repositoryId,_getContentChanges_request.changeToken,_getContentChanges_request.maxItems,_getContentChanges_request.includeACL,_getContentChanges_request.includeProperties,_getContentChanges_request.filter);
        }

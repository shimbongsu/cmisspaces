 ...
 * of this value object you may modify the generated sub-class of this class - CmisAccessControlEntryType.as.
 */
...
import org.integratedsemantics.cmis.soap.valueobject.CmisAccessControlPrincipalType;
...
[ExcludeClass]
public class _Super_CmisAccessControlEntryType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisAccessControlEntryTypeEntityMetadata;

    /**
     * properties
     */
    private var _internal_principal : org.integratedsemantics.cmis.soap.valueobject.CmisAccessControlPrincipalType;
    private var _internal_permission : ArrayCollection;
    private var _internal_direct : Boolean;
    ...
    public function _Super_CmisAccessControlEntryType()
    {
        _model = new _CmisAccessControlEntryTypeEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "principal", model_internal::setterListenerPrincipal));
    ...
    public function get principal() : org.integratedsemantics.cmis.soap.valueobject.CmisAccessControlPrincipalType
    {
    ...
    public function set principal(value:org.integratedsemantics.cmis.soap.valueobject.CmisAccessControlPrincipalType) : void
    {
        var oldValue:org.integratedsemantics.cmis.soap.valueobject.CmisAccessControlPrincipalType = _internal_principal;
        if (oldValue !== value)
        {
            _internal_principal = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "principal", oldValue, _internal_principal));
        }
    }
    ...
    {
        var oldValue:Boolean = _internal_direct;
        if (oldValue !== value)
        {
            _internal_direct = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "direct", oldValue, _internal_direct));
        }
    }
    ...
    model_internal function setterListenerPrincipal(value:flash.events.Event):void
    {
        _model.invalidateDependentOnPrincipal();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.principalIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_principalValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisAccessControlEntryTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisAccessControlEntryTypeEntityMetadata) : void
    {
        var oldValue : _CmisAccessControlEntryTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfPrincipal : Array = null;
    model_internal var _doValidationLastValOfPrincipal : org.integratedsemantics.cmis.soap.valueobject.CmisAccessControlPrincipalType;

    model_internal function _doValidationForPrincipal(valueIn:Object):Array
    {
        var value : org.integratedsemantics.cmis.soap.valueobject.CmisAccessControlPrincipalType = valueIn as org.integratedsemantics.cmis.soap.valueobject.CmisAccessControlPrincipalType;

        if (model_internal::_doValidationCacheOfPrincipal != null && model_internal::_doValidationLastValOfPrincipal == value)
           return model_internal::_doValidationCacheOfPrincipal ;

        _model.model_internal::_principalIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isPrincipalAvailable && _internal_principal == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "principal is required"));
        }

        model_internal::_doValidationCacheOfPrincipal = validationFailures;
        model_internal::_doValidationLastValOfPrincipal = value;

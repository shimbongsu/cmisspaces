 ...
 * of this value object you may modify the generated sub-class of this class - CmisPermissionDefinition.as.
 */
...
[ExcludeClass]
public class _Super_CmisPermissionDefinition extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisPermissionDefinitionEntityMetadata;

    /**
     * properties
     */
    private var _internal_permission : String;
    ...
    public function _Super_CmisPermissionDefinition()
    {
        _model = new _CmisPermissionDefinitionEntityMetadata(this);
    ...
    {
        var oldValue:String = _internal_permission;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisPermissionDefinitionEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisPermissionDefinitionEntityMetadata) : void
    {
        var oldValue : _CmisPermissionDefinitionEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfPermission : String;

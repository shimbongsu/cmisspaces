...
[ExcludeClass]
internal class _CheckOutResponseEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("objectId", "contentCopied", "extension");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("objectId", "contentCopied", "extension");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("objectId", "contentCopied", "extension");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("objectId", "contentCopied", "extension");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array("extension");
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CheckOutResponse";
    ...
    model_internal var _instance:_Super_CheckOutResponse;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CheckOutResponseEntityMetadata(value : _Super_CheckOutResponse)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["contentCopied"] = new Array();
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CheckOutResponse");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CheckOutResponse");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CheckOutResponse");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isContentCopiedAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get contentCopiedStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

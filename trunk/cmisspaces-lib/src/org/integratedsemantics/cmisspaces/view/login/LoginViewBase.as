package org.integratedsemantics.cmisspaces.view.login
{
	...
	import org.integratedsemantics.cmisspaces.view.preferences.PreferencesView;
	...
	// todo note: Only difference from FlexSpaces Login is to have a different PreferencedView / PreferencesPresModel
	// so DI could be used to inject them instead of having duplicated login mxml / as

...
package org.coderepos.atompub
{
	...
	public class AtompubClient extends EventDispatcher
	{
		 ...
		 * @playerversion 9.0
		 */
		public function AtompubClient(cmisConfig:CMISConfig)
		{
			_isFetching = false;
			_credential = null;
			_agent = "cmis-spaces";
		...
		protected function setCommonRequestHeaders(uri:URI, req:AtompubRequest):void
		{
			...
			// non air has problems with user agent header
		...
		protected function requestHttpService(uri:URI, req:AtompubRequest):void
		{
			...
			_client.requestHTTPService(cmisConfig, uri, req, _timeout);      
		}
		...
		public function getCategories(uri:URI):void
		{
			...
			// sreiner todo request(uri, new AtompubRequest("GET"));
		}
		 ...
		 * @playerversion 9.0
		 */
		public function createMedia(uri:URI, content:ByteArray, type:String, slug:String=null):void
		{
		 ...
		 * @playerversion 9.0
		 */
		public function updateMedia(uri:URI, content:ByteArray,	type:String):void
		{

 ...
 * of this value object you may modify the generated sub-class of this class - CmisPropertyBooleanDefinitionType.as.
 */
...
[ExcludeClass]
public class _Super_CmisPropertyBooleanDefinitionType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisPropertyBooleanDefinitionTypeEntityMetadata;
    ...
    private var _internal_defaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyBoolean;
    private var _internal_choice : ArrayCollection;
    model_internal var _internal_choice_leaf:org.integratedsemantics.cmis.soap.valueobject.CmisChoiceBoolean;
    ...
    public function _Super_CmisPropertyBooleanDefinitionType()
    {
        _model = new _CmisPropertyBooleanDefinitionTypeEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get defaultValue() : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyBoolean
    {
    ...
    public function set defaultValue(value:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyBoolean) : void
    {
        var oldValue:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyBoolean = _internal_defaultValue;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisPropertyBooleanDefinitionTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisPropertyBooleanDefinitionTypeEntityMetadata) : void
    {
        var oldValue : _CmisPropertyBooleanDefinitionTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfDefaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyBoolean;

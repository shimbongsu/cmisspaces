 ...
 * of this value object you may modify the generated sub-class of this class - CmisObjectListType.as.
 */
...
[ExcludeClass]
public class _Super_CmisObjectListType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisObjectListTypeEntityMetadata;

    /**
     * properties
     */
    private var _internal_objects : ArrayCollection;
    model_internal var _internal_objects_leaf:org.integratedsemantics.cmis.soap.valueobject.CmisObjectType;
    ...
    public function _Super_CmisObjectListType()
    {
        _model = new _CmisObjectListTypeEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisObjectListTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisObjectListTypeEntityMetadata) : void
    {
        var oldValue : _CmisObjectListTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {

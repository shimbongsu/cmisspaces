 ...
 * of this value object you may modify the generated sub-class of this class - CmisListOfIdsType.as.
 */
...
[ExcludeClass]
public class _Super_CmisListOfIdsType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisListOfIdsTypeEntityMetadata;

    /**
     * properties
     */
    private var _internal_id : ArrayCollection;
    ...
    public function _Super_CmisListOfIdsType()
    {
        _model = new _CmisListOfIdsTypeEntityMetadata(this);
    ...
    public function get id() : ArrayCollection
    {
        return _internal_id;
    }
    ...
    {
        var oldValue:ArrayCollection = _internal_id;
        if (oldValue !== value)
        {
            ...
            {
                _internal_id = new ArrayCollection(value);
            }
            else
            {
                throw new Error("value of id must be a collection");
            }
    ...
    model_internal function setterListenerId(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            ...
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerId);
            }
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisListOfIdsTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisListOfIdsTypeEntityMetadata) : void
    {
        var oldValue : _CmisListOfIdsTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfId : ArrayCollection;

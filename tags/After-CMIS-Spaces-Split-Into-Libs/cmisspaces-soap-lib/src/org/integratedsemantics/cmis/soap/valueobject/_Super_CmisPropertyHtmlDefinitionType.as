 ...
 * of this value object you may modify the generated sub-class of this class - CmisPropertyHtmlDefinitionType.as.
 */
...
[ExcludeClass]
public class _Super_CmisPropertyHtmlDefinitionType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisPropertyHtmlDefinitionTypeEntityMetadata;
    ...
    private var _internal_defaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyHtml;
    ...
    public function _Super_CmisPropertyHtmlDefinitionType()
    {
        _model = new _CmisPropertyHtmlDefinitionTypeEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get defaultValue() : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyHtml
    {
    ...
    public function set defaultValue(value:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyHtml) : void
    {
        var oldValue:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyHtml = _internal_defaultValue;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisPropertyHtmlDefinitionTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisPropertyHtmlDefinitionTypeEntityMetadata) : void
    {
        var oldValue : _CmisPropertyHtmlDefinitionTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfDefaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyHtml;

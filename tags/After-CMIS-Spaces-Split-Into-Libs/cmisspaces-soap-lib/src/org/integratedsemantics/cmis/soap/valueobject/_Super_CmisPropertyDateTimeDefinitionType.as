 ...
 * of this value object you may modify the generated sub-class of this class - CmisPropertyDateTimeDefinitionType.as.
 */
...
[ExcludeClass]
public class _Super_CmisPropertyDateTimeDefinitionType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisPropertyDateTimeDefinitionTypeEntityMetadata;
    ...
    private var _internal_defaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyDateTime;
    private var _internal_resolution : String;
    private var _internal_choice : ArrayCollection;
    model_internal var _internal_choice_leaf:org.integratedsemantics.cmis.soap.valueobject.CmisChoiceDateTime;
    ...
    public function _Super_CmisPropertyDateTimeDefinitionType()
    {
        _model = new _CmisPropertyDateTimeDefinitionTypeEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get defaultValue() : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyDateTime
    {
    ...
    public function set defaultValue(value:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyDateTime) : void
    {
        var oldValue:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyDateTime = _internal_defaultValue;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisPropertyDateTimeDefinitionTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisPropertyDateTimeDefinitionTypeEntityMetadata) : void
    {
        var oldValue : _CmisPropertyDateTimeDefinitionTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfDefaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyDateTime;

...
import org.integratedsemantics.cmis.soap.valueobject.CmisChoiceBoolean;
...
[ExcludeClass]
internal class _CmisPropertyBooleanDefinitionTypeEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("id", "localName", "localNamespace", "displayName", "queryName", "description", "propertyType", "cardinality", "updatability", "inherited", "required", "queryable", "orderable", "openChoice", "anyElement", "defaultValue", "choice");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "localName", "localNamespace", "displayName", "queryName", "description", "propertyType", "cardinality", "updatability", "inherited", "required", "queryable", "orderable", "openChoice", "anyElement", "defaultValue", "choice");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "localName", "localNamespace", "displayName", "queryName", "description", "propertyType", "cardinality", "updatability", "inherited", "required", "queryable", "orderable", "openChoice", "anyElement", "defaultValue", "choice");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "localName", "localNamespace", "displayName", "queryName", "description", "propertyType", "cardinality", "updatability", "inherited", "required", "queryable", "orderable", "openChoice", "anyElement", "defaultValue", "choice");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array("anyElement", "choice");
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CmisPropertyBooleanDefinitionType";
    ...
    model_internal var _instance:_Super_CmisPropertyBooleanDefinitionType;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CmisPropertyBooleanDefinitionTypeEntityMetadata(value : _Super_CmisPropertyBooleanDefinitionType)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::collectionBaseMap["choice"] = "org.integratedsemantics.cmis.soap.valueobject.CmisChoiceBoolean";
        }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CmisPropertyBooleanDefinitionType");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CmisPropertyBooleanDefinitionType");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CmisPropertyBooleanDefinitionType");
        }

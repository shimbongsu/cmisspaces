 ...
 * of this value object you may modify the generated sub-class of this class - CmisPropertyDecimalDefinitionType.as.
 */
...
[ExcludeClass]
public class _Super_CmisPropertyDecimalDefinitionType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisPropertyDecimalDefinitionTypeEntityMetadata;
    ...
    private var _internal_defaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyDecimal;
    private var _internal_maxValue : Number;
    private var _internal_minValue : Number;
    private var _internal_precision : int;
    private var _internal_choice : ArrayCollection;
    model_internal var _internal_choice_leaf:org.integratedsemantics.cmis.soap.valueobject.CmisChoiceDecimal;
    ...
    public function _Super_CmisPropertyDecimalDefinitionType()
    {
        _model = new _CmisPropertyDecimalDefinitionTypeEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get defaultValue() : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyDecimal
    {
    ...
    public function set defaultValue(value:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyDecimal) : void
    {
        var oldValue:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyDecimal = _internal_defaultValue;
        if (oldValue !== value)
        {
    ...
    public function set maxValue(value:Number) : void
    {
        ...
        if (isNaN(_internal_maxValue) == true || Math.abs(oldValue - value) > epsilon)
        {
    ...
    public function set minValue(value:Number) : void
    {
        ...
        if (isNaN(_internal_minValue) == true || Math.abs(oldValue - value) > epsilon)
        {
    ...
    {
        var oldValue:int = _internal_precision;
        if (oldValue !== value)
        {
            _internal_precision = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "precision", oldValue, _internal_precision));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisPropertyDecimalDefinitionTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisPropertyDecimalDefinitionTypeEntityMetadata) : void
    {
        var oldValue : _CmisPropertyDecimalDefinitionTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfDefaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyDecimal;

...
package org.integratedsemantics.cmis.webservice.navigationservice{
    ...
    public interface INavigationService
    {
    	 ...
    	 */
    	function getCheckedoutDocs(repositoryId:String,folderID:String,filter:String,includeAllowableActions:Boolean,includeRelationships:Boolean,maxItems:Number,skipCount:Number):AsyncToken;
        /**
       ...
       function addgetCheckedoutDocsEventListener(listener:Function):void;
    	 ...
    	 * @return An AsyncToken
    	 */
    	function getChildren(repositoryId:String,folderId:String,type:EnumTypesOfFileableObjects,filter:String,includeAllowableActions:Boolean,includeRelationships:Boolean,maxItems:Number,skipCount:Number):AsyncToken;
        /**
         * Method to call the operation on the server without passing the arguments inline.
         * You must however set the _request property for the operation before calling this method
         * Should use it in MXML context mostly
       ...
       function addgetChildrenEventListener(listener:Function):void;
    	 ...
    	 * @return An AsyncToken
    	 */
    	function getObjectParents(repositoryId:String,objectId:String,filter:String,includeAllowableActions:Boolean,includeRelationships:Boolean):AsyncToken;
        /**
         * Method to call the operation on the server without passing the arguments inline.
         * You must however set the _request property for the operation before calling this method
         * Should use it in MXML context mostly
       ...
       function addgetObjectParentsEventListener(listener:Function):void;
    	 ...
    	 * @return An AsyncToken
    	 */
    	function getFolderParent(repositoryId:String,folderId:String,filter:String,includeAllowableActions:Boolean,includeRelationships:Boolean,returnToRoot:Boolean):AsyncToken;
        /**
         * Method to call the operation on the server without passing the arguments inline.
         * You must however set the _request property for the operation before calling this method
         * Should use it in MXML context mostly
       ...
       function addgetFolderParentEventListener(listener:Function):void;
    	 ...
    	 * @return An AsyncToken
    	 */
    	function getDescendants(repositoryId:String,folderId:String,type:EnumTypesOfFileableObjects,depth:Number,filter:String,includeAllowableActions:Boolean,includeRelationships:Boolean):AsyncToken;
        /**
         * Method to call the operation on the server without passing the arguments inline.
         * You must however set the _request property for the operation before calling this method
         * Should use it in MXML context mostly

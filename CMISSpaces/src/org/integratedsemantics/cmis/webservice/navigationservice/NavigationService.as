 ...
 */
  ...
  * myService.getObjectParents(myrepositoryId,myobjectId,myfilter,myincludeAllowableActions,myincludeRelationships);
  *
  * MXML sample code:
  ...
  *		<srv:GetObjectParents_request repositoryId=myValue,objectId=myValue,filter=myValue,includeAllowableActions=myValue,includeRelationships=myValue/>
  *   </srv:getObjectParents_request_var>
...
package org.integratedsemantics.cmis.webservice.navigationservice
{
	...
	public class NavigationService extends EventDispatcher implements INavigationService
	{
        ...
        {
         	var _internal_token:AsyncToken = _baseService.getChildren(repositoryId,folderId,type,filter,includeAllowableActions,includeRelationships,maxItems,skipCount,orderBy);
        ...
        {
        	return getChildren(_getChildren_request.repositoryId,_getChildren_request.folderId,_getChildren_request.type,_getChildren_request.filter,_getChildren_request.includeAllowableActions,_getChildren_request.includeRelationships,_getChildren_request.maxItems,_getChildren_request.skipCount,_getChildren_request.orderBy);
        }
        ...
        {
         	var _internal_token:AsyncToken = _baseService.getDescendants(repositoryId,folderId,type,depth,filter,includeAllowableActions,includeRelationships,orderBy);
        ...
        {
        	return getDescendants(_getDescendants_request.repositoryId,_getDescendants_request.folderId,_getDescendants_request.type,_getDescendants_request.depth,_getDescendants_request.filter,_getDescendants_request.includeAllowableActions,_getDescendants_request.includeRelationships,_getDescendants_request.orderBy);
        }
        ...
        {
         	var _internal_token:AsyncToken = _baseService.getCheckedoutDocs(repositoryId,folderId,filter,orderBy,includeAllowableActions,includeRelationships,maxItems,skipCount);

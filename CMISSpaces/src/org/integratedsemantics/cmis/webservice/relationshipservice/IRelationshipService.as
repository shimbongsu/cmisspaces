...
package org.integratedsemantics.cmis.webservice.relationshipservice{
    ...
    public interface IRelationshipService
    {
    	 ...
    	 */
    	function getRelationships(repositoryId:String,objectId:String,direction:EnumRelationshipDirection,typeId:String,includeSubRelationshipTypes:Boolean,filter:String,includeAllowableActions:Boolean,includeRelationships:EnumIncludeRelationships,maxItems:Number,skipCount:Number):AsyncToken;
        /**

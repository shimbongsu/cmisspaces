 ...
 */
  ...
  * myService.addupdatePropertiesEventListener(myResultHandlingFunction);
  * Step 3: Call the operation as a method on the service. Pass the right values as arguments:
  * myService.updateProperties(myrepositoryId,myobjectId,mychangeToken,myproperties);
  *
  * MXML sample code:
  ...
  *   <srv:updateProperties_request_var>
  *		<srv:UpdateProperties_request repositoryId=myValue,objectId=myValue,changeToken=myValue,properties=myValue/>
  *   </srv:updateProperties_request_var>
  * </srv:ObjectService>
  * Then call the operation for which you have set the request wrapper value above, like this:
  * <mx:Button id="myButton" label="Call operation" click="myService.updateProperties_send()" />
  */

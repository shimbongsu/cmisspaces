 ...
 */
  ...
  * myService.getTypeDefinition(myrepositoryId,mytypeId);
  *
  * MXML sample code:
  ...
  *		<srv:GetTypeDefinition_request repositoryId=myValue,typeId=myValue/>
  *   </srv:getTypeDefinition_request_var>
...
package org.integratedsemantics.cmis.webservice.repositoryservice
{
	...
	public class RepositoryService extends EventDispatcher implements IRepositoryService
	{
		 ...
		 * @private
		 */
        private var _getTypeDefinition_lastResult:Object;
		[Bindable]
		/**
		 * @see IRepositoryService#getTypeDefinition_lastResult
		 */	  
		public function get getTypeDefinition_lastResult():Object
		{
		 ...
		 * @private
		 */
		public function set getTypeDefinition_lastResult(lastResult:Object):void
		{
        ...
        {
         	var _internal_token:AsyncToken = _baseService.getTypes(repositoryId,typeId,returnPropertyDefinitions,maxItems,skipCount);
        ...
        {
        	return getTypes(_getTypes_request.repositoryId,_getTypes_request.typeId,_getTypes_request.returnPropertyDefinitions,_getTypes_request.maxItems,_getTypes_request.skipCount);
        }

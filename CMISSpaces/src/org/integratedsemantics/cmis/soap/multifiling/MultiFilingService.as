 ...
 */
  ...
  * myService.addremoveObjectFromFolderEventListener(myResultHandlingFunction);
  * Step 3: Call the operation as a method on the service. Pass the right values as arguments:
  * myService.removeObjectFromFolder(myrepositoryId,myobjectId,myfolderId,myextension);
  *
  * MXML sample code:
  * First you need to map the package where the files were generated to a namespace, usually on the <mx:Application> tag, 
  * like this: xmlns:srv="org.integratedsemantics.cmis.soap.multifiling.*"
  * Define the service and within its tags set the request wrapper for the desired operation
  * <srv:MultiFilingService id="myService">
  *   <srv:removeObjectFromFolder_request_var>
  *		<srv:RemoveObjectFromFolder_request repositoryId=myValue,objectId=myValue,folderId=myValue,extension=myValue/>
  *   </srv:removeObjectFromFolder_request_var>
  * </srv:MultiFilingService>
  * Then call the operation for which you have set the request wrapper value above, like this:
  * <mx:Button id="myButton" label="Call operation" click="myService.removeObjectFromFolder_send()" />
  */
package org.integratedsemantics.cmis.soap.multifiling
{
     ...
     */
    [Event(name="RemoveObjectFromFolder_result", type="org.integratedsemantics.cmis.soap.multifiling.RemoveObjectFromFolderResultEvent")]
     ...
     */
    [Event(name="AddObjectToFolder_result", type="org.integratedsemantics.cmis.soap.multifiling.AddObjectToFolderResultEvent")]
	...
	public class MultiFilingService extends EventDispatcher implements IMultiFilingService
	{
        ...
        {
         	var _internal_token:AsyncToken = _baseService.removeObjectFromFolder(repositoryId,objectId,folderId,extension);
        ...
        {
        	return removeObjectFromFolder(_removeObjectFromFolder_request.repositoryId,_removeObjectFromFolder_request.objectId,_removeObjectFromFolder_request.folderId,_removeObjectFromFolder_request.extension);
        }
		 ...
		 * @private
		 */
        private var _removeObjectFromFolder_lastResult:CmisExtensionType;
		[Bindable]
		/**
		 * @see IMultiFilingService#removeObjectFromFolder_lastResult
		 */	  
		public function get removeObjectFromFolder_lastResult():CmisExtensionType
		{
		 ...
		 * @private
		 */
		public function set removeObjectFromFolder_lastResult(lastResult:CmisExtensionType):void
		{
        ...
        {
         	var _internal_token:AsyncToken = _baseService.addObjectToFolder(repositoryId,objectId,folderId,allVersions,extension);
        ...
        {
        	return addObjectToFolder(_addObjectToFolder_request.repositoryId,_addObjectToFolder_request.objectId,_addObjectToFolder_request.folderId,_addObjectToFolder_request.allVersions,_addObjectToFolder_request.extension);
        }
		 ...
		 * @private
		 */
        private var _addObjectToFolder_lastResult:CmisExtensionType;
		[Bindable]
		/**
		 * @see IMultiFilingService#addObjectToFolder_lastResult
		 */	  
		public function get addObjectToFolder_lastResult():CmisExtensionType
		{
		 ...
		 * @private
		 */
		public function set addObjectToFolder_lastResult(lastResult:CmisExtensionType):void
		{

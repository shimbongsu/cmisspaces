...
package org.integratedsemantics.cmis.soap.multifiling{
    ...
    public interface IMultiFilingService
    {
    	 ...
    	 */
    	function removeObjectFromFolder(repositoryId:String,objectId:String,folderId:String,extension:CmisExtensionType):AsyncToken;
        /**
         ...
         */
        function get removeObjectFromFolder_lastResult():CmisExtensionType;
		/**
		 * @private
		 */
        function set removeObjectFromFolder_lastResult(lastResult:CmisExtensionType):void;
       /**
       ...
       function addremoveObjectFromFolderEventListener(listener:Function):void;
    	 ...
    	 * @return An AsyncToken
    	 */
    	function addObjectToFolder(repositoryId:String,objectId:String,folderId:String,allVersions:Boolean,extension:CmisExtensionType):AsyncToken;
        /**
         * Method to call the operation on the server without passing the arguments inline.
         * You must however set the _request property for the operation before calling this method
         * Should use it in MXML context mostly
         ...
         */
        function get addObjectToFolder_lastResult():CmisExtensionType;
		/**
		 * @private
		 */
        function set addObjectToFolder_lastResult(lastResult:CmisExtensionType):void;
       /**

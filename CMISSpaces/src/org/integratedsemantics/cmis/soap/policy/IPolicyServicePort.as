...
package org.integratedsemantics.cmis.soap.policy{
    ...
    public interface IPolicyServicePort
    {
    	 ...
    	 */
    	function removePolicy(repositoryId:String,policyId:String,objectId:String,extension:CmisExtensionType):AsyncToken;
        /**
         ...
         */
        function get removePolicy_lastResult():CmisExtensionType;
		/**
		 * @private
		 */
        function set removePolicy_lastResult(lastResult:CmisExtensionType):void;
       /**
       ...
       function addremovePolicyEventListener(listener:Function):void;
    	 ...
    	 * @return An AsyncToken
    	 */
    	function applyPolicy(repositoryId:String,policyId:String,objectId:String,extension:CmisExtensionType):AsyncToken;
        /**
         * Method to call the operation on the server without passing the arguments inline.
         * You must however set the _request property for the operation before calling this method
         * Should use it in MXML context mostly
         ...
         */
        function get applyPolicy_lastResult():CmisExtensionType;
		/**
		 * @private
		 */
        function set applyPolicy_lastResult(lastResult:CmisExtensionType):void;
       /**
       ...
       function addapplyPolicyEventListener(listener:Function):void;
    	 ...
    	 * @return An AsyncToken
    	 */
    	function getAppliedPolicies(repositoryId:String,objectId:String,filter:String,extension:CmisExtensionType):AsyncToken;
        /**
         * Method to call the operation on the server without passing the arguments inline.
         * You must however set the _request property for the operation before calling this method
         * Should use it in MXML context mostly

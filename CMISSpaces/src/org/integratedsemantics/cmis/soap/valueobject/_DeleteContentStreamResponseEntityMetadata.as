...
[ExcludeClass]
internal class _DeleteContentStreamResponseEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("objectId", "changeToken", "extension");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("objectId", "changeToken", "extension");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("objectId", "changeToken", "extension");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("objectId", "changeToken", "extension");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array("extension");
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "DeleteContentStreamResponse";
    ...
    model_internal var _changeTokenIsValid:Boolean;
    model_internal var _changeTokenValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _changeTokenIsValidCacheInitialized:Boolean = false;
    model_internal var _changeTokenValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_DeleteContentStreamResponse;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _DeleteContentStreamResponseEntityMetadata(value : _Super_DeleteContentStreamResponse)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["changeToken"] = new Array();
        ...
        model_internal::_changeTokenValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForChangeToken);
        model_internal::_changeTokenValidator.required = true;
        model_internal::_changeTokenValidator.requiredFieldError = "changeToken is required";
        //model_internal::_changeTokenValidator.source = model_internal::_instance;
        //model_internal::_changeTokenValidator.property = "changeToken";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity DeleteContentStreamResponse");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity DeleteContentStreamResponse");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity DeleteContentStreamResponse");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isChangeTokenAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnChangeToken():void
    {
        if (model_internal::_changeTokenIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfChangeToken = null;
            model_internal::calculateChangeTokenIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get changeTokenStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get changeTokenValidator() : StyleValidator
    {
        return model_internal::_changeTokenValidator;
    }

    model_internal function set _changeTokenIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_changeTokenIsValid;         
        if (oldValue !== value)
        {
            model_internal::_changeTokenIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "changeTokenIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get changeTokenIsValid():Boolean
    {
        if (!model_internal::_changeTokenIsValidCacheInitialized)
        {
            model_internal::calculateChangeTokenIsValid();
        ...
        return model_internal::_changeTokenIsValid;
    }

    model_internal function calculateChangeTokenIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_changeTokenValidator.validate(model_internal::_instance.changeToken)
        model_internal::_changeTokenIsValid_der = (valRes.results == null);
        model_internal::_changeTokenIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::changeTokenValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::changeTokenValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get changeTokenValidationFailureMessages():Array
    {
        if (model_internal::_changeTokenValidationFailureMessages == null)
            model_internal::calculateChangeTokenIsValid();

        return _changeTokenValidationFailureMessages;
    }

    model_internal function set changeTokenValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_changeTokenValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_changeTokenValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "changeTokenValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("changeToken"):
            {
                return changeTokenValidationFailureMessages;
            }
            case("extension"):
            {

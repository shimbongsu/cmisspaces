 ...
 * of this value object you may modify the generated sub-class of this class - CheckOutResponse.as.
 */
...
[ExcludeClass]
public class _Super_CheckOutResponse extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CheckOutResponseEntityMetadata;

    /**
     * properties
     */
    private var _internal_objectId : String;
    private var _internal_contentCopied : Boolean;
    ...
    public function _Super_CheckOutResponse()
    {
        _model = new _CheckOutResponseEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get contentCopied() : Boolean
    {
        return _internal_contentCopied;
    }
    ...
    public function set contentCopied(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_contentCopied;
        if (oldValue !== value)
        {
            _internal_contentCopied = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "contentCopied", oldValue, _internal_contentCopied));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CheckOutResponseEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CheckOutResponseEntityMetadata) : void
    {
        var oldValue : _CheckOutResponseEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {

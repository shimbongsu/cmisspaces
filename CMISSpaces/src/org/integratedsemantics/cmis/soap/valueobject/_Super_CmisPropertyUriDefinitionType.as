 ...
 * of this value object you may modify the generated sub-class of this class - CmisPropertyUriDefinitionType.as.
 */
...
[ExcludeClass]
public class _Super_CmisPropertyUriDefinitionType extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CmisPropertyUriDefinitionTypeEntityMetadata;
    ...
    private var _internal_defaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyUri;
    private var _internal_choice : ArrayCollection;
    model_internal var _internal_choice_leaf:org.integratedsemantics.cmis.soap.valueobject.CmisChoiceUri;
    ...
    public function _Super_CmisPropertyUriDefinitionType()
    {
        _model = new _CmisPropertyUriDefinitionTypeEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get defaultValue() : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyUri
    {
    ...
    public function set defaultValue(value:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyUri) : void
    {
        var oldValue:org.integratedsemantics.cmis.soap.valueobject.CmisPropertyUri = _internal_defaultValue;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CmisPropertyUriDefinitionTypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CmisPropertyUriDefinitionTypeEntityMetadata) : void
    {
        var oldValue : _CmisPropertyUriDefinitionTypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfDefaultValue : org.integratedsemantics.cmis.soap.valueobject.CmisPropertyUri;

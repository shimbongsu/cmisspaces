package org.integratedsemantics.flexspaces.view.app
{
	...
	public class AppBase extends Application
	{
        ...
        //cmis protected var configService:ConfigService = ConfigService.instance;  
        ...
        public function AppBase()
        {
            ...
            // cmis configService.addEventListener(ConfigCompleteEvent.CONFIG_COMPLETE, onConfigComplete);
            
            // spring actionscript config
            // todo add in flexspaces and put in overrideable method
